...
class EmailService {
    ...
    async sendTransactionAlert(userEmail, userName, transaction) {
    ...
    async sendBudgetAlert(userEmail, userName, teamName, budgetInfo) {
    ...
    generateTransactionAlertTemplate(data) {
