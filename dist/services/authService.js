...
const forgotPassword = async (email) => {
    ...
    try {
        ...
        if (isDevelopmentMode) {
            ...
            global.tempResetTokens.set(resetToken, {
                userId: user.id,
                email: email,
...
const resetPassword = async (token, newPassword) => {
    ...
    try {
        if (isDevelopmentMode) {
            ...
            const tempTokens = global.tempResetTokens;
            if (!tempTokens) {
...
const sendTransactionNotification = async (userEmail, userName, transactionData) => {
    try {
        const transaction = {
...
const sendBudgetAlert = async (userEmail, userName, teamName, budgetData) => {
    try {
